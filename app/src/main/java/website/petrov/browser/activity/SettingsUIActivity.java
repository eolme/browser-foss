...
import website.petrov.browser.fragment.FragmentSettingsUI;
...
public class SettingsUIActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new FragmentSettingsUI()).commit();
    }
