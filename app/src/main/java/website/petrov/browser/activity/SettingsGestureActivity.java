...
import website.petrov.browser.fragment.FragmentSettingsGesture;
...
public class SettingsGestureActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new FragmentSettingsGesture()).commit();
    }
